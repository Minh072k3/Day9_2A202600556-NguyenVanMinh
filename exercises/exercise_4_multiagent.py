...
class State(TypedDict):
    ...
    privacy_analysis: Annotated[str, _last_wins]  # Bài 4.1: Thêm field mới
    final_response: str
...
def check_routing(state: State) -> list[Send]:
    ...
    # Bài 4.2: Thêm conditional routing cho privacy_agent
...
Tập trung vào: GDPR, data protection, privacy rights, data breach notifications,
CCPA/CPRA, quyền riêng tư dữ liệu cá nhân."""
...
def aggregate_results(state: State) -> dict:
    ...
    # Bài 4.1: Thêm privacy_analysis vào sections
...
def build_graph() -> StateGraph:
    ...
    # Bài 4.1: Thêm privacy_agent node
    ...
    # Bài 4.1: Thêm edge từ privacy_agent đến aggregate_results
