...
LEGAL_KNOWLEDGE = [
    ...
    # Bài 2.1: Thêm entry về luật lao động Việt Nam
    {
        "id": "labor_law",
...
async def main():
    ...
    # Đã thêm check_statute_of_limitations vào danh sách tools
    ...
    if response.tool_calls:
        for tool_call in response.tool_calls:
            ...
            # Dùng tool_map để tự động tìm tool đúng
            ...
            if tool_fn:
                ...
                print(f"   ⚠️ Tool '{tool_call['name']}' không tìm thấy!")
